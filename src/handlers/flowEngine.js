...
const SERVICE_KEYWORDS = {
  ...
  office:      ['cctv', 'biometric', 'furniture', 'interior', 'office setup',
                'networking'],
  virtual_office: ['virtual office', 'business address', 'mail handling',
                'mail forwarding'],
  // Deliberately excludes bare "agreement"/"business agreement" — those
  // are too ambiguous with legal's "agreement drafting" (contract
  // review vs. paying stamp duty on an already-drafted document), so
  // only the unambiguous e-stamp-specific terms are listed here.
  estamp:      ['e-stamp', 'estamp', 'e stamp', 'stamp duty', 'stamp paper'],
